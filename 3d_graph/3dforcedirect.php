...
force.charge(function (d) {return d.weight * dynamic_weight;});
...
//	.attr("xlink:href", function(d){return d.link;})
	.attr("xlink:href", function(d){if (d.link) {return d.link;}})
...
//    console.log(d.weight/10 + ", " + d.name + ", " + Math.ceil(d.weight/10) * 5 + ", CEILING TEST")
    return nearest(Math.log(d.weight) * 10,5,5,5) || 10;})
      .style('stroke', function(d) {return d.url_color;})
      .style('fill', function(d) { return d.color; })
      .on("mouseover", function(d) {
          d3.select(this).attr("r", function (d) {return nearest(Math.log(d.weight) * 10,5,5,5) * 1.1 || 10;})
    ...
    .on("mouseout", function(d) {
        d3.select(this).attr("r", function (d) {return nearest(Math.log(d.weight) * 10,5,5,5) || 10;})
        link.style('stroke-width', 1)
        link.style('stroke', function(d) {return d.color; })
      });
      
  node.append("text")
      .attr("dx", function(d) {return (nearest(Math.log(d.weight) * 10,5,5,5) + 5);})
      .attr("dy", ".35em")
