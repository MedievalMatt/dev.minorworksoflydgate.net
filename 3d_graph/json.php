...
function limiter($type, $ids)
{
	...
	else
	{
		...
		{
		case "work":
			$where_limiter = " Work.id in ($ids)";
			break;

		case "witness":
			$where_limiter = " Witness.id in ($ids)";
			break;

		case "location":
			$where_limiter = " Location.id in ($ids)";
			break;

		case "region":
			$where_limiter = " Region.id in ($ids)";
			break;

		case "city":
			$where_limiter = " City.id in ($ids)";
			break;

		case "country":
			$where_limiter = " Country.id in ($ids)";
			break;

		case "person":
			$where_limiter = " Person.id in ($ids)";
			break;
...
//	reset($array);
	...
	if(is_null($row['subquery_work_id'])) {
		...
		//debug_to_console($row['Work'] . "returned a null for subquery_work_id on person_other_work_linker. Work_id is " . $row['Work_id']);
...
//	reset($array);
	...
	if(is_null($row['subquery_work_id'])) {
		...
		//debug_to_console($row['Work'] . "returned a null for subquery_work_id on person_other_Lydgate_work_linker. Work_id is " . $row['Work_id']);
...
//	reset($array);
	...
	if(is_null($row['subquery_work_id'])) {
		...
		//debug_to_console($row['Work'] . "returned a null for subquery_work_id on other_work_linker. Work_id is " . $row['Work_id']);
...
//	reset($array);
	...
	if(is_null($row['subquery_work_id'])) {
		...
		//debug_to_console($row['Work'] . "returned a null for subquery_work_id on other_Lydgate_work_linker. Work_id is " . $row['Work_id']);
...
$where_limiter = " Work.id in (" . $get . ")";
$URL_limiter = " Work.id not in (" . $get . ")";
