...
function structure_model(f, side, g, total_g, q) {
  ...
  document.write(
    '<svg width="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 110">'
  );
  ...
  for (j = start; j < end; j++) {
    ...
    if (j == f) {
      ...
      console.log(
        "side = " + side + " and lm1 = " + lm1 + ", but pm1 = " + pm1
      );
      ...
      document.write(
        "<!-- M lm1 lm2 C lc1 lc2 , ld1 ld2 , le1 le2 , lf1 lf2 -->"
      );
      document.write(
        '<path d="M ' +
          lm1 +
          ...
          '" stroke="' +
          isOdd(folio) +
          '" stroke-width=".5%" stroke-linecap="round" fill="transparent"/> '
      );
      document.write(
        "<!-- M pm1 pm2 C pc1 pc2 , pd1 pd2 , pe1 pe2 , pf1 pf2 -->"
      );
      document.write(
        '<path d="M ' +
          pm1 +
          ...
          " " +
          pf2 +
          '" stroke="#39ff14" stroke-width=".25%" stroke-linecap="round" fill="transparent"/> '
      );
    } else {
      document.write(
        "<!-- M fm1 fm2 C fc1 fc2 , fd1 fd2 , fe1 fe2 , ff1 ff2 -->"
      );
      document.write(
        '<path d="M ' +
          fm1 +
...
function compare_toggle_visibility(id, line, collection, marginalia) {
  ...
  console.log(
    "/XML/XQuery/test_command_line.php" +
      "?collection=" +
      collection +
      "&zone=" +
      id +
